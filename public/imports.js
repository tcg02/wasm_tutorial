...
function jsFunction(n){ console.log("Call from EM JS: "+n) }
...
var real____em_js__jsFunction = asm["__em_js__jsFunction"];
asm["__em_js__jsFunction"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
...
var ___em_js__jsFunction = Module["___em_js__jsFunction"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__em_js__jsFunction"].apply(null, arguments)
};
